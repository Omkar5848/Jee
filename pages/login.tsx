      ...
      <div className={styles.card}>
        ...
        <div className={styles.modeSwitch}>
          <button
            ...
            onClick={() => { setMode('password'); setError(undefined); setMsg(undefined); }}
          >
            Password
          </button>
          <button
            type="button"
            className={`${styles.modeButton} ${mode === 'otp' ? styles.modeButtonActive : ''}`}
            onClick={() => { setMode('otp'); setError(undefined); setMsg(undefined); }}
          >
            OTP
          </button>
        </div>
        ...
        {mode === 'password' ? (
          <>
            ...
            <form onSubmit={onPasswordLogin}>
              ...
              <button className={styles.button} disabled={loading}>{loading ? 'Signing in...' : 'Sign In'}</button>
            </form>
          </>
        ) : (
          <>
            ...
            <form onSubmit={onOtpLogin}>
              ...
              <button className={styles.button} disabled={loading || !otpSent}>{loading ? 'Verifying...' : 'Sign In with OTP'}</button>
            </form>
          </>
        )}
